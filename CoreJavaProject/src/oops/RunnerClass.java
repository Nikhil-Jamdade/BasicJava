...
public class RunnerClass {
	...
	public static void main(String[] args) {
		...
		ct2.Print(); //It'll print SSN as preference will be given to the same class

		System.out.println("**** Creating obj1");
		Insurance obj1 = new Insurance();
		obj1.InsuranceId = 3000;
		obj1.SSN = 999;
		obj1.Print(); //It'll print Insurance ID as preference will be given to the same class
